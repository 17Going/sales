<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input class="filter-item" style="width:200px;" @keyup.enter.native="privateSerFilter"
                placeholder="请输入客户区域/客户名称">
      </el-input>
      ...
      <el-table-column align="center" label="电话跟进" width="100">
        <template scope="scope">
          <div style="display:inline-flex">
            ...
            <el-button type="danger" size="mini" @click="telephoneInVisableFn" icon="el-icon-edit"
                       style="padding:5px 8px 5px 8px;">录入
            </el-button>
          </div>
        </template>
      </el-table-column>
    ...
    <el-dialog title="电话跟进记录" :visible.sync="telephoneInVisable">
      <template slot-scope="scope">
        <el-form :model="telephoneInForm" :rules="telephoneInRules" ref="telephoneInForm" label-width="100px"
                 class="demo-ruleForm">
