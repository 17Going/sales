export default {
  route: {
    ...
    privateSea: 'Private Sea',
    MySingleCustomer: 'My Single Customer',
    newCustomers: 'New Customers',
    retrievingCustomers: 'Retrieving Customers',
    highSeas: 'International Waters',
    openPool: 'Open pool',
    salesManagement: 'Sales Management',
    SubordinateCustomers: 'Subordinate Customers',
    SubordinateSingleCustomer: 'Subordinate To A Single Customer',
    Rationale: 'Rationale',
    business: 'Business',
    sticky: 'Sticky',
    countTo: 'CountTo',
